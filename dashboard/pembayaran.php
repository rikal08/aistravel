              ...
              <div class="col-lg-12 mb-12">
                <div class="card">
                  ...
                  <div class="card-header"> 
                    ...
                    <a href="" data-toggle="modal" data-target="#laporan"  class="btn btn-danger"><i class="fa fa-print"></i> Buat Laporan Perbulan</a>
                    <?php include"laporan-pembayaran.php"  ?>

                    <a href="" data-toggle="modal" data-target="#laporan-perpaket"  class="btn btn-danger"><i class="fa fa-print"></i> Laporan Pembayaran Perpaket</a>
                    <?php include"laporan-pembayaran-perpaket.php" ?>
                  </div>
                  <div class="card-body"> 
                                        ...
                                        <tbody>
                                          <?php 
                                           function rupiah($angka)
                                            ...
                                            $no=1;
                                            $pemesanan=mysqli_query($koneksi,"SELECT * FROM tb_pemesanan where  status=2 ORDER BY id_pemesanan DESC");
                                          ...
                                          <div id="upload<?= $dt_pemesanan['id_pemesanan']  ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                                            <div role="document" class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <form action="aksi/input_pembayaran.php" method="POST" enctype="multipart/form-data">
                                                    <div class="form-group">
